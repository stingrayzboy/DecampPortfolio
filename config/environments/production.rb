Rails.application.configure do
  ...
  config.assets.precompile += %w(javascripts/ckeditor/* )
  ...
  config.action_cable.allowed_request_origins = ['https://faraz-noor-portfolio.herokuapp.com', 'http://faraz-noor-portfolio.herokuapp.com']
  config.action_cable.url = "wss://faraz-noor-portfolio.herokuapp.com/cable"
end
