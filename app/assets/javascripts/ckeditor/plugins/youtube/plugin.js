					...
					onOk: function()
					{
						...
						if (this.getContentElement('youtubePlugin', 'txtEmbed').isEnabled()) {
							...
							if (this.getContentElement('youtubePlugin', 'chkResponsive').getValue() === true) {
								content += '<div class="youtube-embed-wrapper embed-responsive embed-responsive-16by9" style="position:relative;padding-bottom:56.25%;padding-top:30px;height:0;overflow:hidden">';
							...
							if (this.getContentElement('youtubePlugin', 'chkNoEmbed').getValue() === true) {
								...
								content += '<iframe class="embed-responsive-item" src="' + url + '" ' + responsiveStyle;
